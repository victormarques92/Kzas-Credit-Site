...
"use strict";$(document).ajaxStart(function(){$("body").css("overflow","auto"),$("body").append('<div class="preloader"><i class="fas fa-spinner fa-spin"></i></div>')}).ajaxStop(function(){$(".body").removeClass(".preloader"),$("body").removeClass("preloader-site"),$("body").css("overflow","auto")}),$("body").addClass("animated fadeIn"),$(document).ready(function(){$("select").niceSelect()});
"use strict";$(function(){[{value:"date",format:"00/00/0000"},{value:"time",format:"00:00:00"},{value:"date_time",format:"00/00/0000 00:00:00"},{value:"cep",format:"00000-000"},{value:"phone",format:"0000-0000"},{value:"phone_with_ddd",format:"(00) 0000-0000"},{value:"cellphone",format:"00000-0000"},{value:"cellphone_with_ddd",format:"(00) 00000-0000"},{value:"cpf",format:"000.000.000-00",settings:{reverse:!0}},{value:"cnpj",format:"00.000.000/0000-00",settings:{reverse:!0}},{value:"money",format:"000.000.000.000.000,00",settings:{reverse:!0}},{value:"money2",format:"#.##0,00",settings:{reverse:!0}},{value:"validation_code",format:"000000",settings:{reverse:!0}}].forEach(function(e){e.settings?$("."+e.value).mask(e.format,e.settings):$("."+e.value).mask(e.format)})});
"use strict";function btnAnaliseJuridica(){$('[data-id="banco-selecionado"]').find("input").is(":checked")?$(".analise-juridica").slideDown(800):$(".analise-juridica").slideUp()}$('[data-id="banco-selecionado"]').click(function(i){i.preventDefault();var e=$(this).find("input");e.is(":checked")?e.removeAttr("checked"):e.attr("checked","checked"),btnAnaliseJuridica()});
"use strict";$(function(){var n=$('.index-form-component div[data-id="validation-code"]');$('.index-form-component .btn[data-id="btn-send-code"]').addClass("secundary"),n.hide(),$('.index-form-component .btn[data-id="btn-send-code"]').click(function(e){e.preventDefault(),""!==$(".index-form-component input#mobile-phone").val()&&($(this).removeClass("secundary").addClass("secundary-invert").text("Reenviar código"),$(n).slideDown())}),$(".index-form-component .validation_code").keyup(function(){6<=$(this).val().length?$('.index-form-component .btn[data-id="create-account"]').removeClass("disabled").addClass("secundary"):$('.index-form-component .btn[data-id="create-account"]').removeClass("secundary").addClass("disabled")})});
"use strict";function bancoSelecionado(){var e=$('.btn[data-id="solicitar-aprovacao"]');$('.table-component .label-checkbox[data-id="banco-preferencia"]').find("input").is(":checked")?e.removeClass("disabled").addClass("secundary"):e.removeClass("secudnary").addClass("disabled")}$('.table-component .label-checkbox[data-id="banco-preferencia"]').click(function(e){e.preventDefault();var a=$(this).find("input");a.is(":checked")?a.removeAttr("checked"):a.attr("checked","checked"),bancoSelecionado()});
"use strict";$(document).ready(function(){setTimeout(function(){$('[data-id="waiting"]').hide(),$(".content-page").fadeIn()},8e3)});
"use strict";function uniaoEstavel(){var t=$(".box-conjuge"),n=$('.input-switch[data-id="uniao-estavel-cartorio"]');$('.input-switch[data-id="uniao-estavel"]').find("input").is(":checked")?(t.slideDown(800),n.slideDown()):(t.slideUp(800),n.slideUp())}function showFgtsTitular(){var t=$('[data-id="valor-fgts-titular"]');$('.input-switch[data-id="usar-fgts-titular"]').find("input").is(":checked")?t.slideDown(800):t.slideUp(800)}function showFgtsConjuge(){var t=$('[data-id="valor-fgts-conjuge"]');$('.input-switch[data-id="usar-fgts-conjuge"]').find("input").is(":checked")?t.slideDown(800):t.slideUp(800)}function financiamentoConjuge(){var t=$(".box-conjuge .financiamento-conjuge");$('.input-switch[data-id="conjuge-compor-compra"]').find("input").is(":checked")?t.slideDown(800):t.slideUp(800)}function numeration(){var t=$('.component-tabs-body[data-id="tab-1"] .box-fonte-renda[data-id="titular"] .item-renda');0<t.length&&t.find(".num-renda").text(function(t){return t+1});var n=$('.component-tabs-body[data-id="tab-1"] .box-fonte-renda[data-id="conjuge"] .item-renda');0<n.length&&n.find(".num-renda").text(function(t){return t+1});var a=$('.component-tabs-body[data-id="tab-2"] .box-fonte-renda[data-id="titular"] .item-renda');0<a.length&&a.find(".num-renda").text(function(t){return t+1});var e=$('.component-tabs-body[data-id="tab-2"] .box-fonte-renda[data-id="conjuge"] .item-renda');0<e.length&&e.find(".num-renda").text(function(t){return t+1})}function hideShowButtons(){var t=$('.component-tabs-body[data-id="tab-1"] .box-fonte-renda[data-id="titular"] .item-renda');t.not(t.last()).find(".btn").attr("data-id","remove-fonte-renda-titular"),t.not(t.last()).find(".btn").text("Remover esta fonte de renda"),t.last().find(".btn").attr("data-id","add-fonte-renda-titular");var n=$('.component-tabs-body[data-id="tab-1"] .box-fonte-renda[data-id="conjuge"] .item-renda');n.not(n.last()).find(".btn").attr("data-id","remove-fonte-renda-conjuge"),n.not(n.last()).find(".btn").text("Remover esta fonte de renda"),n.last().find(".btn").attr("data-id","add-fonte-renda-conjuge");var a=$('.component-tabs-body[data-id="tab-2"] .box-fonte-renda[data-id="titular"] .item-renda');a.not(a.last()).find(".btn").attr("data-id","remove-fonte-renda-titular"),a.not(a.last()).find(".btn").text("Remover esta fonte de renda"),a.last().find(".btn").attr("data-id","add-fonte-renda-titular");var e=$('.component-tabs-body[data-id="tab-2"] .box-fonte-renda[data-id="conjuge"] .item-renda');e.not(e.last()).find(".btn").attr("data-id","remove-fonte-renda-conjuge"),e.not(e.last()).find(".btn").text("Remover esta fonte de renda"),e.last().find(".btn").attr("data-id","add-fonte-renda-conjuge")}$('.input-switch[data-id="uniao-estavel"]').click(function(t){t.preventDefault();var n=$(this).find("input");n.is(":checked")?n.removeAttr("checked"):n.attr("checked","checked"),uniaoEstavel()}),$("select#renda").change(function(){var t=$(this).val(),n=$(this).parent().parent().parent().parent().find(".info-empresa");"assalariado"==t||"empresario"==t?n.slideDown(800):n.slideUp(800)}),$(document).ready(function(){numeration(),hideShowButtons(),$(".btn").bind("click",".btn",function(t){t.preventDefault();var n=$(this).parent().parent().parent(),a=$(this).parent().parent().parent().parent().parent().parent().attr("data-id"),e=$(this).parent().parent().parent().parent().parent().parent().parent().find(".box-fonte-renda");console.log(a),"add-fonte-renda-titular"===$(this).attr("data-id")&&($(n).clone(!0).appendTo('[data-id="'+a+'"] .box-fonte-renda[data-id="titular"]'),numeration()),"add-fonte-renda-conjuge"===$(this).attr("data-id")&&(console.log(e),$(n).clone(!0).appendTo(e),numeration()),"remove-fonte-renda-titular"===$(this).attr("data-id")&&($(n).remove(),numeration()),"remove-fonte-renda-conjuge"===$(this).attr("data-id")&&($(n).remove(),numeration()),1<$(".box-fonte-renda .item-renda").length&&hideShowButtons()})}),$('.input-switch[data-id="usar-fgts-titular"]').click(function(t){t.preventDefault();var n=$(this).find("input");n.is(":checked")?n.removeAttr("checked"):n.attr("checked","checked"),showFgtsTitular()}),$('.input-switch[data-id="usar-fgts-conjuge"]').click(function(t){t.preventDefault();var n=$(this).find("input");n.is(":checked")?n.removeAttr("checked"):n.attr("checked","checked"),showFgtsConjuge()});
"use strict";$(function(){$("[open-modal]").click(function(o){o.stopPropagation(),$(".modal-component").removeClass("active");var a=$(this).attr("open-modal");$('.modal-component[data-id="'+a+'"]').addClass("active")}),$("[close]").click(function(o){o.preventDefault(),$(".modal-component").removeClass("active")})});
"use strict";function showDestaques(){var e=$(".table-component .item .destaque");$('.table-component .input-switch[data-id="show-destaques"]').find("input").is(":checked")?e.addClass("active"):e.removeClass("active")}$('.table-component .input-switch[data-id="show-destaques"]').click(function(e){e.preventDefault();var t=$(this).find("input");t.is(":checked")?t.removeAttr("checked"):t.attr("checked","checked"),showDestaques()});
"use strict";var tabsHead=$(".tabs-component .list-head-item");tabsHead.click(function(){var t=$(this).attr("data-id");$(".list-head-item, .component-tabs-body").removeClass("active"),$(this).toggleClass("active"),$('.component-tabs-body[data-id="'+t+'"]').toggleClass("active")});